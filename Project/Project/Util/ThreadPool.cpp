...
// ImageModel*				Task::m_imagemodel;
// cv::String				Task::m_image_Path;
// string					Task::m_image_Name;

int Task::Task1(PVOID p)
{
// 	m_imagemodel->Lock_(true);
// 	m_imagemodel->OnLoadImage(m_image_Path, m_image_Name);
// 
// 	cv::Mat temp_cvSrcmat = m_imagemodel->GetCvSrcmat();
// 	string temp_image_name = m_imagemodel->GetImageName();
// 	string temp_image_path = m_imagemodel->GetImagePath();
// 	int temp_mat_width = m_imagemodel->GetMatWidth();
// 	int temp_mat_height = m_imagemodel->GetMatHeight();
// 	m_imagemodel->Lock_(false);
// 
// 	m_imagemodel->OnDetection(true, temp_cvSrcmat, temp_image_name, temp_image_path, temp_mat_width, temp_mat_height);
