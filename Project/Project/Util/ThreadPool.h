...
{
public:
// 	static void SetImageModel(ImageModel *gModel) { m_imagemodel = gModel; };
// 	static void SetParameter(cv::String c_str, string str) { m_image_Path = c_str, m_image_Name = str; };
	static int	Task1(PVOID p);

private:
//	static ImageModel	*m_imagemodel;
//	static cv::String	m_image_Path;
